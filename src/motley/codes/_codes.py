...
_fg_effects = {
    ...
    # 21                    Bold: off or Underline: Double  Bold off not widely
...
BG_CODES = {
    ...
    # 63:       ideogram double overline or double line on the left side hardly
    #           ever supported
    # 64:       ideogram stress marking: hardly ever supported
    # 65:       ideogram attributes off: hardly ever supported, reset the
    #           effects of all of 60–64
    # ------------------------------------------------------------------------ #
    'dark gray':        100,
    'bright red':       101,
    'bright green':     102,
